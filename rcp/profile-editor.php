...
if ( is_user_logged_in() ):
	...
	<form id="rcp_profile_editor_form" class="rcp_form" action="<?php echo rcp_get_current_url(); ?>" method="post">
		<fieldset>
			...
			<p id="rcp_profile_user_name_wrap">
				<label for="rcp_user_name"><?php _e( 'Username', 'rcp' ); ?> <span><i>(cannot be changed)</i> This is your log-in name for your account access; no one sees this except for you when you log in.</span></label>
				<input name="rcp_user_login" id="rcp_user_login" class="text rcp-input" type="text" disabled="disabled" value="<?php echo esc_attr( $current_user->user_login ); ?>" />
			</p>
			...
			<p id="rcp_profile_first_name_wrap">
				<label for="rcp_first_name"><?php _e( 'First Name', 'rcp' ); ?> <span>Your first given name that you are formally recognized as. <i>This will be printed on your certificate.</i></span></label>
			...
			<p id="rcp_profile_last_name_wrap">
				<label for="rcp_last_name"><?php _e( 'Last Name', 'rcp' ); ?> <span>Your current legal last name. <i>This will also be printed on your certificate.</i></span></label>
				<input name="rcp_last_name" id="rcp_last_name" class="text rcp-input" type="text" value="<?php echo esc_attr( $last_name ); ?>" />
			</p>
			
			<p>
				<label for="rcp_email"><?php _e( 'Email Address', 'rcp' ); ?> <span>Valid email address for course correspondence; PLEASE double check your spelling!</span></label>
        ...
        <fieldset>
			<legend><?php _e( 'Update Password', 'rcp' ); ?></legend>
			<p id="rcp_change_password_instr">Enter a new password below only if you would like to update your password. Otherwise, you should leave these fields empty to keep your password unchanged.</p>
