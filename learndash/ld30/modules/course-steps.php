		...
		if ( $learndash_maybe_show_next_step_link ) :
			...
			elseif ( ( true === $can_complete ) && ( true === $current_complete ) &&  ( ! empty( $incomplete_button ) ) ) :
				...
				if( learndash_lesson_hasassignments( $course_step_post ) )
					echo "<div class='nb-assignment-status-course-step' >
							<div class='nb-assignment-complete'>". __( 'Completed', NBCS_TD) ."</div>
							<small>(". __( 'Your trainer has marked this assignment as completed.', NBCS_TD) .")</small>
						</div>"; 
				else 
				...
				if( learndash_lesson_hasassignments( $course_step_post ) )
					echo "<div class='nb-assignment-status-course-step' >
							<div class='nb-assignment-incomplete'>". __( 'Incomplete', NBCS_TD) ."</div>
							<small>(". __( 'Your trainer will mark this as completed when graded.', NBCS_TD) .")</small>
						</div>"; 
