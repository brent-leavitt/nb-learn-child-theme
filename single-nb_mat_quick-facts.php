...
?>
						...
						<div class="col-md-7 product-summary-case">
							<div class="summary qf-summary postclass">
								...
								<?php 								
									if( cbl_user_is( 'paying' ) && $downloads ):
								?>	
								...
								<div class="mat-register-prompt">
									...
									<p>To access downloadable copies you must 
									first be registered for a paying option.</p>
								</div>
